...
void fiil(){
      ...
      */
      ...
      tft.fillRoundRect(145, 96, 75, 25, 3, YELLOW); //Ashar
      tft.fillRoundRect(145, 122, 75, 25, 3, RED); // Magrib
      tft.fillRoundRect(145, 148, 75, 25, 3, MAGENTA); //Isya
